...
public class RichTextEditor extends ScrollView {
    ...
    public void insertContent(String content) {
        ...
        lastFocusEdit.setSelection(content.length());
    }
    ...
    private EditText createEditText(String hint, int paddingTop) {
        EditText editText = (EditText) inflater.inflate(R.layout.richeditor_edit_item1,
                null);
    ...
    private RelativeLayout createImageLayout() {
        RelativeLayout layout = (RelativeLayout) inflater.inflate(
                R.layout.richeditor_edit_imageview, null);
    ...
    public void insertImage(String imagePath) {
        mScreenWidth = Integer.parseInt(SharedPreferenceUtil.getString(getContext(), Constant.SCREEN_WIDTH));
        Bitmap bmp = getScaledBitmap(imagePath, mScreenWidth);
    ...
    private void addImageViewAtIndex(final int index, Bitmap bmp,
        ...
        // 调整imageView的高度
        int imageHeight = mScreenWidth * bmp.getHeight() / bmp.getWidth();
