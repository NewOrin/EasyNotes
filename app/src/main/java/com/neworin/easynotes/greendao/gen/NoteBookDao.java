...
public class NoteBookDao extends AbstractDao<NoteBookModel, Long> {
    ...
    /**
     * Properties of entity NoteBookModel.<br/>
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, NoteBookModel entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, NoteBookModel entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getId());
    ...
    @Override
    public NoteBookModel readEntity(Cursor cursor, int offset) {
        NoteBookModel entity = new NoteBookModel( //
    ...
    @Override
    public void readEntity(Cursor cursor, NoteBookModel entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(NoteBookModel entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(NoteBookModel entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(NoteBookModel entity) {
